...
public class ShooterConfig {
    ...
    public static final HashMap<Integer, Double> FEET_TO_RPM_MAP = new HashMap<Integer, Double>() {{
        put(2, 2300.0 + 50.0); // 2400
        put(3, 2300.0 + 50.0); // 2400
        put(4, 2300.0 + 50.0); // 2400
        put(5, 2300.0 + 50.0); // 2400
        put(6, 2400.0 + 50.0); // 2500
        put(7, 2500.0 + 50.0); // 2600
        put(8, 2600.0 + 50.0); // 2700
        put(9, 2700.0 + 50.0); // 2800
        put(10, 2800.0 + 50.0); // 2900
        put(11, 2900.0 + 50.0); // 3000
        put(12, 3000.0 + 50.0); // 3100
        ...
        put(19, 3900.0 + 50.0); // 4000
        put(20, 4000.0 + 50.0); // 4100
        put(21, 4100.0 + 50.0); // 4200
        put(22, 4200.0 + 50.0); // 4300
        put(23, 4300.0 + 50.0); // 4400
        put(24, 4400.0 + 50.0); // 4500
    }};
